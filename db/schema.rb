...
ActiveRecord::Schema[8.0].define(version: 2025_07_31_150534) do
  ...
  create_table "intersection_captions", force: :cascade do |t|
    t.bigint "report_id", null: false
    t.string "intersection_id", limit: 50, null: false
    t.string "caption", limit: 50, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["report_id", "intersection_id"], name: "index_intersection_captions_on_report_and_intersection", unique: true
    t.index ["report_id"], name: "index_intersection_captions_on_report_id"
  end
  ...
  add_foreign_key "intersection_captions", "reports", on_delete: :cascade
